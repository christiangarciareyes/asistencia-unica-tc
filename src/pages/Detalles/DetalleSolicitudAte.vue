        ...
        <div class="col-lg-12">
          ...
          <div class="news_post">
            ...
            <div class="news_post_top d-flex flex-column flex-sm-row">
              <div class="news_post_title_container">
                ...
                <div class="news_post_meta">
                  <span class="news_post_author"><a style="color: #AF52BF">Visualiza la solicitud ingresada</a></span>
                </div>
              </div>
            </div>
            </div>
            ...
            <div class="news_post_text m-l-32 m-r-32">
              <p>En el siguiente formulario visualizarás el detalle de la solicitud.</p>
            </div>
