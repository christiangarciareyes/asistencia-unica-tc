        ...
        <div class="col-lg-12">
          ...
          <div class="news_post">
            ...
            <div class="news_post_top d-flex flex-column flex-sm-row">
              <div class="news_post_title_container">
                <div class="news_post_title">
                  ...
                  <a style="color: #AF52BF">Realiza Auditoría al Reclamo</a>
                </div>
                <div class="news_post_meta">
                  <span class="news_post_author"><a style="color: #AF52BF">Verifica los datos y atención del reclamo</a></span>
                </div>
              </div>
            </div>
            </div>
            ...
            <div class="news_post_text m-l-32 m-r-32">
              <p>En el siguiente formulario verificarás el detalle del reclamo, como tambien podrás auditarlo.</p>
            </div>
