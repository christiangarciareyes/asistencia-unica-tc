            ...
            <div class="pbar_container m-t-20 m-b-40 m-l-32 m-r-32">
              ...
              <div class="news_post_text">
                ...
                <div class="container-form-btn fonTap m-t-40">
                  ...
                  <button v-if="correo != '--'" v-on:click="seguir" class="routing-form-btn m-r-10 m-l-10 mb-3 fuente"> HOJA DE SEGUIMIENTO</button>
                </div>
  ...
  methods: {
     ...
     enviar (){
        ...
        if(this.atencion != ''){
          ...
          fromData.append('departamento', this.departamento);
          fromData.append('distrito', this.distrito);
          ...
          fromData.append('formaentrega', this.forma);
          fromData.append('especificacion', this.entrega);
          ...
          axios.post(this.$store.state.serverAsistenciaAdmin + '/updateSolicitud2', fromData, {crossDomain: true, headers: {"Authorization": this.authorization}
          }).then((response) => {
            this.isLoading = false;
            this.atras();
            this.notifyVue4();
     ...
     corregir (){
        ...
        fromData.append('iddetalletipoasistencia', this.idregistro);
        fromData.append('idtipoasistencia', 2);
        axios.post(this.$store.state.serverAsistenciaAdmin + '/updateSolicitud', fromData, {crossDomain: true, headers: {"Authorization": this.authorization}
        }).then((response) => {
     ...
     llenado(){
      this.idregistro = this.$store.state.solicitud.nid_detalletipoasistencia
      this.codreclamo = this.$store.state.solicitud.cnum_numperio
      this.fecreclamo = this.$store.state.solicitud.dfec_registro
      ...
      if(this.$store.state.solicitud.nflg_permiso == '1'){
        this.permiso = 'La persona ' + this.nombres + ' autorizó el envío de su archivo como atención por medio de un link o enlace de descarga que será enviada a su correo electrónico.';
        this.alertPerm = 'margin-top: -15px; color: blue';
      }else{
        this.permiso = 'La persona ' + this.nombres + ' no autorizó el envío de su archivo como atención por medio de un link o enlace de descarga que será enviada a su correo electrónico.';
        this.alertPerm = 'margin-top: -15px; color: red';
      }
      ...
      this.estado = this.$store.state.solicitud.nflg_estado
     }
  },
  components: {
    Loading,
