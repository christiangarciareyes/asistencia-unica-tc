            ...
            <div class="news_post_top d-flex flex-column flex-sm-row">
              <div class="news_post_title_container">
                <div class="news_post_title">
                  ...
                  <a style="color: #AF52BF">Visualiza el Documento de la Solicitud</a>
                </div>
                <div class="news_post_meta">
                  <span class="news_post_author"><a style="color: #AF52BF">Descarga e imprime la solicitud ingresada</a></span>
                </div>
              </div>
            </div>
            <div class="news_post_text m-l-32 m-r-32">
              <p>En el siguiente visor visualizarás el documento de la solicitud, como tambien podrás descargarlo e imprimirlo.</p>
            </div>
...
export default{
  ...
  methods: {
     ...
     notifyVue() {
       this.$notify(
        {
          message: 'Solicitud descargada correctamente!',
          icon: 'add_alert',
