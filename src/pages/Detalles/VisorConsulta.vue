            ...
            <div class="news_post_top d-flex flex-column flex-sm-row">
              <div class="news_post_title_container">
                <div class="news_post_title">
                  ...
                  <a style="color: #AF52BF">Visualiza el Documento de la Consulta</a>
                </div>
                <div class="news_post_meta">
                  <span class="news_post_author"><a style="color: #AF52BF">Descarga e imprime la consulta ingresada</a></span>
                </div>
              </div>
            </div>
            <div class="news_post_text m-l-32 m-r-32">
              <p>En el siguiente visor visualizarás el documento de la consulta, como tambien podrás descargarlo e imprimirlo.</p>
            </div>
...
export default{
  ...
  methods: {
     ...
     notifyVue() {
       this.$notify(
        {
          message: 'Consulta descargada correctamente!',
          icon: 'add_alert',
     ...
     createPdf(){
        ...
        if(this.persona == null || this.persona == 'null' || this.persona == ''){
         this.persona = ''
        }
        ...
        watermark: {text: userWater, color: 'blue', opacity: 0.3, bold: true, italics: true },
            ...
            content: [
                ...
                {
                    stack: [
                    'DOCUMENTO DE LA CONSULTA ' + this.codreclamo,
                ],
                    style: 'header'
                },
                {
                    ...
                    text: [
                    {
                        ...
                        'Nombres y Apellidos: ' + this.nombres + '\n',
                        'Correo Electrónico: ' + this.correo + '\n',
                        'Correo Electrónico 2: ' + this.correo2 + '\n',
                ...
                },
                {
                        ...
                        text: [
                    {
                        ...
                        'N° de Expediente: ' + this.expediente + '\n',
                        'Tipo de Persona: ' + this.persona + '\n',
                        'Canal donde Ingreso: ' + this.canal + '\n',
                        'Detalle de la Consulta: ' + this.detalle + '\n'
                        ]
                    },
                    ]
                },
