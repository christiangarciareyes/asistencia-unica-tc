            ...
            <div class="news_post_top d-flex flex-column flex-sm-row">
              <div class="news_post_title_container">
                <div class="news_post_title">
                  ...
                  <a style="color: #AF52BF">Consulta el Detalle del Reclamo en Quechua</a>
                </div>
                <div class="news_post_meta">
                  <span class="news_post_author"><a style="color: #AF52BF">Responde la derivación del reclamo en quechua ingresado</a></span>
                </div>
              </div>
            </div>
            </div>
  ...
  created() {
    if(localStorage.getItem('AccessToken') != null && localStorage.getItem('expires_at') != null && localStorage.getItem('profile') != null && localStorage.getItem('operaciones') != null && localStorage.getItem('nickname') != null){
      if(this.$store.state.reclamoQue == ''){
        ...
        this.usuarioderivado = this.$store.state.reclamoQue.ctxt_usuarioderivado
        this.nomusuarioderivado = this.$store.state.reclamoQue.ctxt_nomusuarioderivado
        this.correoderivado = this.$store.state.reclamoQue.ctxt_correoderivado
  ...
  methods: {
    ...
    notifyVue() {
     ...
     notifyVue4() {
       this.$notify(
        {
          message: 'Reclamo en Quechua respondido correctamente!',
          icon: 'add_alert',
          horizontalAlign: 'left',
          verticalAlign: 'top',
          type: 'success'
